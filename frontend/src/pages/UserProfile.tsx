                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            ...
                            anywhere (outside a text field) to cycle through the three VeloChat themes.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="grid grid-cols-3 gap-3">
                            {([
                                { value: "light", label: "Velo Light", Icon: Sun },
                                { value: "obsidian", label: "Obsidian Night", Icon: Moon },
                                { value: "forest", label: "Forest Proxy", Icon: Monitor },
