...
<head>
  ...
  <title>New Message on VeloChat</title>
</head>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f0f2f5;padding:40px 0;">
    <tr>
      <td align="center">
        <table width="520" cellpadding="0" cellspacing="0"
          ...
          <!-- Header -->
          <tr>
            <td align="center" style="background:linear-gradient(135deg,#064e3b 0%,#10b981 100%);padding:32px 40px;">
              <h1 style="margin:0;color:#ffffff;font-size:24px;font-weight:700;letter-spacing:0.5px;">VeloChat</h1>
          ...
          <tr>
            <td style="padding:36px 40px 28px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background-color:#ecfdf5;border-left:4px solid #10b981;border-radius:0 8px 8px 0;padding:14px 18px;">
          ...
          <tr>
            <td align="center" style="background-color:#f9fafb;border-top:1px solid #e5e7eb;padding:18px 40px;">
              <p style="margin:0;font-size:12px;color:#9ca3af;">
                You're receiving this because email notifications are enabled on your VeloChat account.
              </p>
              <p style="margin:4px 0 0;font-size:12px;color:#9ca3af;">
                To disable, visit <a href="${FRONTEND_URL}/user/profile" style="color:#10b981;">Settings → Notifications</a>.
              </p>
    ...
    transporter
        .sendMail({
            from: `"VeloChat" <${EMAIL}>`,
            to: receiver.email,
            subject: `💬 ${sender.name} sent you a message on VeloChat`,
            html,
        })
        .catch((err) => {
